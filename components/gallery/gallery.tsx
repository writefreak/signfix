...
// How far (in card-widths) a slide sits from center before it's culled from the DOM.
...
export default function DesktopGallery({ items }: GalleryCarouselProps) {
  ...
  // Compute each item's offset from the active slide, wrapped to the shortest path
  // around the loop (so the last slide can sit immediately left of the first, etc.)
    ...
    <div className="w-full hidden md:block">
      ...
      <div className="pt-14 flex items-center justify-center gap-4">
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full bg-lime  text-neutral-700 transition-colors   focus-visible:outline  focus-visible:outline-offset-2 focus-visible:outline-neutral-400"
        >
